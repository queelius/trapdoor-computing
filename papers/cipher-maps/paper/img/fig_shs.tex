...
\begingroup%
  ...
  \begin{picture}(1,0.55063496)%
    \put(0.38,0.078){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\mathsmaller{h(x_2 + b) \mod 4}$}}}%
    ...
    \put(0.41093171,0.41327568){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\mathsmaller{h(x_3 + b) \mod 4}$}}}%
    \put(0.35,0.275){\color[rgb]{0,0,0}\makebox(0,0)[lb]{\smash{$\mathsmaller{h(x_1 + b) \mod 4}$}}}%
