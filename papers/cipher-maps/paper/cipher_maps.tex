...
bits-per-element are reported below.
...
boolean-search numbers above.  The Bloom-baseline experiment is at
\texttt{.papermill/experiments/2026-05-23/e1\_bloom\_baseline.py};
results in CSV form at \texttt{.../e1/results.csv}, full discussion
at \texttt{.../e1/summary.md}.  The numbers above are from one run
per cell; variance characterization across replicates and against
SSE baselines at matched operating points is work in progress
