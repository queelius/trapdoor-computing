...
matched per-document false-positive rate, on the same 20 Newsgroups
corpus.  For $m \in \{1000, 5000, 18266\}$ documents and target
...
Zipf with skew $s = 1$.  Cipher value space $\{0,1\}^n$ with $n$
