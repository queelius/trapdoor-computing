...
prove the composition theorem governing error accumulation, and present two
construction strategies---batch (seed search) and online (algebraic)---spanning
complementary parameter regimes.  The batch construction, the entropy cipher
map, achieves the information-theoretic lower bound of
$-\log_2 \varepsilon + H(Y)$ bits per element; the online construction, the
trapdoor Boolean algebra, enables incremental set operations without seed search.
\end{abstract}
