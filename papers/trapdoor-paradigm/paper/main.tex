...
and maps the body of work, an abstraction, an algebra, a confidentiality
theory, and concrete constructions, that develops it.
\end{abstract}
...
$e = H(Q)/H^{*}$, the entropy of the observed token distribution $Q$ as a
fraction of the maximum on the populated support, and the representation-%
uniformity parameter $\delta$ lower-bounds it through a Fannes--Audenaert
continuity inequality, linear in $\delta$~\cite{towell2026maxconf}. Small
