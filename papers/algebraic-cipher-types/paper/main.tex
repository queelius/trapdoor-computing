...
SSE~\cite{curtmola2006searchable} enables keyword search on
encrypted documents with simulation-based security.
...
leakage profiles.
Naveed et al.~\cite{naveed2015inference} demonstrated inference
attacks on property-preserving encryption; cipher maps avoid
property preservation entirely.
...
$\fhat_i : \cipher{A}_i \to \cipher{A}_{i+1}$ and the cipher
