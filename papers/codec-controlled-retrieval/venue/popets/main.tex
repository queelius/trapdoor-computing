...
an estimate of two fixed laws whose separation is frequency-independent; here $\delta$
...
only sharpen an adversary's estimate of two fixed, frequency-independent laws whose
...
fixed, frequency-independent separation that no number of queries can widen, so a single
