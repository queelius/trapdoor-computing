...
\]
the probability that a non-member is incorrectly decoded as True.
This equals the fraction of hash space allocated to the True region
in the cipher Boolean type.
