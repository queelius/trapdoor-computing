...
studied extensively in the QIF literature~\cite{smith2009foundations,alvim2020science}.
...
Our contribution is not the measure itself but its application to the
cipher map framework: the parameter decomposition connecting $e$ to
$(\eta, \varepsilon, \delta, \mu)$ and the three levers for improving it.
...
\item If $K(x) = 1$ for all $x$ (simple substitution, no multiple
  ...
  $e \leq H(D) / \log_2 |X|$.
\item The entropy ratio is bounded by $e \geq 1 - 2\delta^2/n$,
