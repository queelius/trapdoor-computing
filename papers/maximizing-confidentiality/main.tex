...
\emph{false positive rate} (FPR): the probability that a non-member
query is incorrectly decoded as True.  This is controlled by the
fraction of hash space allocated to the True region in the cipher
Boolean type.
