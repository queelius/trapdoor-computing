...
LaTeX research paper: "The Entropy Ratio: Quantitative Confidentiality for Trapdoor Computing" (Alexander Towell, 26 pages, 6 theorems, 4 tables, 4 figures). Theory paper grounded in the cipher map framework. The paper is organized around an explicit **two-scale frame**:
