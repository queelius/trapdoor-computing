...
Appendix~\ref{subsec:fpr-compounding} covers the correctness facet:
...
Appendix~\ref{subsec:fpr-compounding} and confirmed in
...
\section{Finite-Sample Resolution of \texorpdfstring{$\delta$}{delta}}
...
\section{Empirical Anchor for the Compression Estimator}
\label{app:anchor}
