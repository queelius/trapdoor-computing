...
The framework grew from work begun in 2017 and carried through 2020, then set
aside, and recovered, re-derived, and carried further, in 2024; the Bernoulli
model of approximate data structures, developed alongside it, supplies the
error theory the trapdoor side builds on, and the debt to it runs through
every part. This draft is a living manuscript, and the
