...
arity, so the reachable set can grow super-linearly along the chain. A loose
upper bound on the total an adversary can reach is the sum of the per-step
frontiers, a quantity that grows with both the chain's length and the arity
of its operations.
