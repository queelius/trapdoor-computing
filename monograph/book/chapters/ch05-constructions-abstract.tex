...
\emph{shape} of the regions, concentrated versus spread, controls how well a
multi-instance adversary can align independent cipher maps for the same
function; the choice that is space-optimal here and the choice that is
confidentiality-optimal there are not the same, a tension the confidentiality
part takes up. With this chapter the keystone is complete: the cipher map is
