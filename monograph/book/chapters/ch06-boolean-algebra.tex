...
Take $n = 8$ and the watchlist $S = \{\mathrm{alice}, \mathrm{carol}\}$ of
\Cref{ex:watchlist-numbers} beside a second list
$V = \{\mathrm{carol}, \mathrm{dave}\}$. Suppose $h$ places alice at bit
$1$, carol at bit $6$, and dave at bit $2$, so
\[
...
\Cref{part:constructions}; the confidentiality of what the equality channel
leaks is taken up at the active-adversary scale later in this part.
